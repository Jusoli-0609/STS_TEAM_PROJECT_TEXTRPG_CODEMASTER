...
void Monster::Initialize_Monster(Monster_Type monster_Type)
{
	...
	case Monster_Type::BOOL_MUSHROOM:
	{
		...
		_attack_Message = "bool 버섯이 갓으로 밀어붙였다!!!";
	...
	case Monster_Type::IF_GOBLIN:
	{
		...
		_attack_Message = "if 고블린이 빠르게 검을 휘둘렀다!!!";
	...
	case Monster_Type::ARRAY_JELLYFISH:
	{
		...
		_attack_Message = "array 해파리가 촉수를 휘둘렀다!!!";
	...
	case Monster_Type::FOR_SHARK:
	{
		...
		_attack_Message = "for 상어가 빠른 속도로 돌진했다!!!";
	...
	case Monster_Type::WHILE_WHALE:
	{
		...
		_attack_Message =  "while 고래가 꼬리로 내려쳤다!!!";
	...
	case Monster_Type::PARAMETER_GIANT_FLY:
	{
		...
		_attack_Message = "parameter 거대파리가 빠르게 날아와 들이받았다!!!";
	...
	case Monster_Type::RETURN_GARGOYLE:
	{
		...
		_attack_Message = "return 가고일이 날개를 펼쳐 내리쳤다!!!";
	...
	case Monster_Type::FUNCTION_MAGE:
	{
		...
		_attack_Message = "function 마도사가 마력을 발사했다!!!";
	...
	case Monster_Type::POINTER_GHOST:
	{
		...
		_attack_Message = "pointer 유령이 순식간에 접근해 할퀴었다!!!";
	...
	case Monster_Type::NULL_BANSHEE:
	{
		...
		_attack_Message = "null 밴시가 날카로운 비명으로 공격했다!!!";
	...
	case Monster_Type::MEMORY_REAPER:
	{
		...
		_attack_Message = "memory 사신이 낫을 휘둘렀다!!!";
	...
	case Monster_Type::CLASS_MACHINE_DOLL:
	{
		...
		_attack_Message = "class 기계인형이 주먹을 휘둘렀다!!!";
	...
	case Monster_Type::INHERITANCE_CHIMERA:
	{
		...
		_attack_Message = "inheritance 키메라가 여러 기계팔로 공격했다!!!";
	...
	case Monster_Type::VECTOR_DRONE:
	{
		...
		_attack_Message = "vector 드론이 기관총 세례를 퍼부었다!!!";
...
void Monster::Print_Monster_Info() const
{
	...
	cout << "처치 경험치: " << _exp_Reward << endl;
	cout << "처치 점수: " << _score_Reward << endl;
	cout << "========================================" << endl;
